...
export default function WelcomeScreen() {
  ...
  return (
    <View className="flex-1 mt-7 bg-slate-200">
      ...
      <View className='flex-row container mx-auto bg-slate-200 m-2 p-3 rounded-3xl shadow-2xl  shadow-black '>
         <Text className="text-xl font-bold text-gray-800 dark:text-white italic">Stars :</Text>
         <Text className='text-xl text-gray-600 dark:text-gray-200 italic'> {i.stars}</Text>
      </View>
      <View className='flex-row container mx-auto bg-slate-200 m-2 p-3 rounded-3xl shadow-2xl  shadow-black '>
    ...
    <View className='flex-row container mx-auto bg-slate-200 m-2 p-3 rounded-3xl shadow-2xl  shadow-black '>
      <Text className="text-xl font-bold text-gray-800 dark:text-white italic">Starting rate :</Text>
      <Text  className='text-xl text-gray-600 text-underline italic'> {i.startingRate} DA</Text>
    </View>
